...
export async function POST(req: NextRequest) {
    try {
        ...
        const digital_human_id = body.digital_human_id;
        ...
        const result = await assistant.createDigitalHumanAgentInstance(agent_id, user_id, {
            RoomId: room_id,
        ...
        const digital_human_config = result.Data.DigitalHumanConfig;
